...
## __¿Qué es la recursión?__

La __recursión__ es una técnica donde una función se llama a sí misma para resolver un problema.
...
## __<span style={{color: 'var(--main-secondary)'}}>PASO 4</span> ↙<br/> Probar el método__
